...
/**
 * Class that calls the Bellman-Ford algorithm and takes the source node from
 * the user
 *
 * @author Emilia Gosiewska version 5.0
 */
@WebServlet(name = "BellmanFord", urlPatterns = {"/BellmanFord"})
public class BellmanFordServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<h1> Result of Bellman-Ford algorithm: </h1>");
            out.println("</head>");
            out.println("<body>");
